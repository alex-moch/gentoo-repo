...
inherit autotools gnuconfig java-pkg-opt-2
...
SLOT="0/23" # subslot = major soname version
...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-4.15.0-exclude-usr-local.patch
...
tsk_prepare_libewf() {
	...
	# Bundled libewf ships a 2013-vintage config.sub that predates
	# aarch64 and musl. Refresh from gnuconfig.
	gnuconfig_update "${TSK_LIBEWF_SRCDIR}"
}
