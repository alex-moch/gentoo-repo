...
SRC_URI="
	${MY_PN}-Full-${MY_PV/./H}u1-${PV_BUILD}.x86_64.bundle
	macos-guests? (
...
pkg_nofetch() {
	einfo "${MY_PN}-Full-${MY_PV/./H}u1-${PV_BUILD}.x86_64.bundle should be downloaded manually"
}
...
src_unpack() {
	...
	local bundle="${MY_PN}-Full-${MY_PV/./H}u1-${PV_BUILD}.x86_64.bundle"
	chmod 755 "${bundle}"
