...
PATCHES=(
	...
	# not merged into 6.0.0-Alpha releases. Carried over from Gentoo's own
	# capstone ebuild (bug #911481) since it applies unchanged (fuzzy match,
	# same as upstream Gentoo's own alpha7 ebuild).
